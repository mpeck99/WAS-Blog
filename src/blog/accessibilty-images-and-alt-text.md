...
btn: Read more about image accessibility
...
Actionable images or iamges that are used for a user to perform a specific function or action **_MUST_** have alternative text. This alternative text must be meaningful and describe to the user what the button/action is meant to do and not what it looks like
